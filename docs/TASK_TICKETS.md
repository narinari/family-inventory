...
#### 詳細タスク
- [ ] アイテム種別（itemTypes）にタグフィールド追加
- [ ] 箱（boxes）にタグフィールド追加
- [ ] 保管場所（locations）にタグフィールド追加
- [ ] API: アイテム種別のタグ更新エンドポイント
- [ ] API: 箱のタグ更新エンドポイント
- [ ] API: 保管場所のタグ更新エンドポイント
- [ ] Web: アイテム種別編集画面にタグ選択UI追加
- [ ] Web: 箱編集画面にタグ選択UI追加
- [ ] Web: 保管場所編集画面にタグ選択UI追加
...
#### 詳細タスク
- [ ] API: アイテム取得時に関連タグを含める
- [ ] Web: アイテム詳細画面でタグを種類別に表示
- [ ] タグの出所（アイテム/種別/箱/場所）を視覚的に区別
